 ...
 * Code Snippet 22 provides an example of this.
 ...
 |googleWebClientId|String|This is the web client id that was created when you set up sign-in with Google. It can found in the Credentials page under 'APIs and Service' in the <a href = "https://console.cloud.google.com/home/dashboard?project=firebase-tutorialapplication"> Google Cloud Platform</a> page|
